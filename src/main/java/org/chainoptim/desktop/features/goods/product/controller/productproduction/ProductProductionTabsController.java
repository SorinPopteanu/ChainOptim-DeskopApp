...
public class ProductProductionTabsController implements TabsActionListener {
    ...
    private static final Map<String, String> tabsViewPaths = Map.of(
            "Product Graph", "/org/chainoptim/desktop/features/goods/productproduction/ProductGraphView.fxml",
            "Add Stage", "/org/chainoptim/desktop/features/goods/productproduction/CreateProductStageView.fxml",
            "Update Stage", "/org/chainoptim/desktop/features/goods/productproduction/UpdateProductStageView.fxml"
    );
