...
public class FactoryProductionTabsController implements TabsActionListener {
    ...
    private static final Map<String, String> tabsViewPaths = Map.of(
            "Factory Graph", "/org/chainoptim/desktop/features/production/factoryproduction/FactoryGraphView.fxml",
            "Add Stage", "/org/chainoptim/desktop/features/production/factoryproduction/CreateFactoryStageView.fxml",
            "Update Stage", "/org/chainoptim/desktop/features/production/factoryproduction/UpdateFactoryStageView.fxml",
            "Allocation Plan", "/org/chainoptim/desktop/features/production/factoryproduction/AllocationPlanView.fxml",
            "Production History", "/org/chainoptim/desktop/features/production/factoryproduction/ProductionHistoryView.fxml",
            "Add Production Record", "/org/chainoptim/desktop/features/production/factoryproduction/AddProductionRecordView.fxml"
    );
