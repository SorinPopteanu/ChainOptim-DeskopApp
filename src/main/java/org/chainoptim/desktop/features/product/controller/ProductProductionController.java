...
import org.chainoptim.desktop.features.product.controller.productproduction.ProductProductionTabsController;
import org.chainoptim.desktop.features.product.controller.productproduction.ProductProductionToolbarController;
...
public class ProductProductionController implements DataReceiver<Product>, ProductionToolbarActionListener {
    ...
    private void loadTabs() {
        FXMLLoader loader = fxmlLoaderService.setUpLoader("/org/chainoptim/desktop/features/product/productproduction/ProductProductionTabsView.fxml", MainApplication.injector::getInstance);
        try {
    ...
    private void loadToolbar() {
        FXMLLoader loader = fxmlLoaderService.setUpLoader("/org/chainoptim/desktop/features/product/productproduction/ProductProductionToolbarView.fxml", MainApplication.injector::getInstance);
        try {
